/*
 * Copyright 2017 The Netty Project & lolnet.co.nz
 * 
 ...
 */
public class ProxyHAProxyMessageDecoder extends ByteToMessageDecoder {
    /**
     ...
     */
    public ProxyHAProxyMessageDecoder() {
     ...
     */
    public ProxyHAProxyMessageDecoder(int maxTlvSize) {
        if (maxTlvSize < 1) {
